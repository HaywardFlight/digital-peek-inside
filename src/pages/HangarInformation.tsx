        ...
        <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="bg-aviation-white/10 rounded-lg p-6">
                    <h3 className="text-xl font-bold text-aviation-white mb-3">Towing</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-aviation-white/10 rounded-lg p-6">
                    <h3 className="text-xl font-bold text-aviation-white mb-3">Getting Ready</h3>
                    <p className="text-aviation-white/90 leading-relaxed">
          ...
          <Card className="bg-aviation-gold/10 border-aviation-gold/30">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold text-aviation-white mb-4">24-Hour Notice Required</h3>
              ...
              <div className="mt-6 space-y-2">
                ...
                <p className="text-aviation-white/80">Email: hfhangars@gmail.com</p>
              </div>
            </CardContent>
          </Card>
        </div>
